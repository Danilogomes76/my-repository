    ...
    <section id="social">
      <div className="text-primary flex text-3xl after:content-['_‎']">
        ...
        <div className="flex gap-2">
          <span className="text-my_gray">Social</span>
          <span className="cursor-default hidden lg:block">-----------</span>
        </div>
      </div>

      <section className="mt-12 flex justify-between gap-12 lg:gap-12 lg:flex-row flex-col">
        <p className="lg:w-1/2 text-my_gray">
          Estou interessado em oportunidades de trabalho. No entanto, caso você
          tenha alguma outra solicitação ou dúvida, não hesite em entrar em
          contato comigo. :)
        </p>
        <div className="border border-my_gray flex flex-col gap-2 self-center lg:self-auto text-my_gray p-4">
